...
merged.to_csv(f"./csv_files/DEBIAS-M_runs/semi_leaky/debiased_lognorm_{id_dict[i]}.csv", index = False)
...
weights_df.to_csv(f"./csv_files/DEBIAS-M_runs/semi_leaky/debias_weights_{id_dict[i]}.csv")
