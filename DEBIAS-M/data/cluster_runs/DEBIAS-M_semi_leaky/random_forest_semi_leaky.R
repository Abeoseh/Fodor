...
png(paste("./output/post_DEBIAS-M_RF_lognorm_ROC_", ID_label, ".png", sep=""))#, height = 24, width = 24)
...
png(paste("./output/post_DEBIAS-M_RF_lognorm_histogram_", ID_label, ".png", sep=""))
...
if(file.exists("./csv_files/AUCs/semi_leaky/semi_leaky_AUCs.csv")){
  all <- read.csv("./csv_files/AUCs/semi_leaky/semi_leaky_AUCs.csv")
  all <- rbind(all, auc.df)
  write.csv(all, "./csv_files/AUCs/semi_leaky/semi_leaky_AUCs.csv", row.names = FALSE)
}else{(write.csv(auc.df, "./csv_files/AUCs/semi_leaky/semi_leaky_AUCs.csv", row.names = FALSE))}

write.csv(auc.df, paste("./csv_files/AUCs/semi_leaky/post_DEBIAS_",ID_label,"_AUCs.csv",sep=""), row.names = FALSE)
