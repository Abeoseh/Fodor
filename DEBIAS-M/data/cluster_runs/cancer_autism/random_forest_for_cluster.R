...
lognorm_out <- read.csv("./csv_files/autism_log_DEBIAS-M.csv", colClasses = c("Phenotype" = "factor")) # after lognorm before DEBIAS-M
...
png(paste("./output/autism/autism_pre_DEBIAS-M_RF_lognorm_ROC_", IDs[i], ".png", sep=""))#, height = 24, width = 24)
...
png(paste("./output/autism/autism_pre_DEBIAS-M_RF_lognorm_histogram_", IDs[i], ".png", sep=""))
...
write.csv(auc.df, paste("./csv_files/AUCs/semi_leaky_autism/autism_pre_DEBIAS_",IDs[i],"_AUCs.csv",sep=""), row.names = FALSE)
